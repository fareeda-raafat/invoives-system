                    ...
                    <form action="{{ route('invoices.update', $invoices->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ date('Y-m-d') }}" value="{{ $invoices->invoice_Date }}"
                                    required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="{{ $invoices->section_id }}" selected disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="rate_vat" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="{{ $invoices->rate_vat }}" disabled>{{ $invoices->rate_vat }}
                                    </option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3" value="{{ $invoices->note }}"></textarea>
                            </div>
                        </div><br>
